...
import { isTruthy, joinSymbolDisplayParts, printer, typeToString } from './util';
        ...
        methods.push({
          ...
          parameters: declaration.parameters.map((parameter, i) => {
            ...
            return {
              ...
              defaultValue: parameter.initializer && nodeToString(parameter.initializer, ts.EmitHint.Expression),

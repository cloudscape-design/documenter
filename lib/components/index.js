...
function writeComponentsDocumentation({ outDir, ...options }) {
    ...
    for (const definition of definitions) {
        node_fs_1.default.writeFileSync(pathe_1.default.join(outDir, definition.dashCaseName + '.js'), `module.exports = ${JSON.stringify(definition, null, 2)};`);
    }
    ...
    node_fs_1.default.writeFileSync(pathe_1.default.join(outDir, 'index.d.ts'), `import { ComponentDefinition } from './interfaces';
...
function documentComponents(options) {
    ...
    return sourceFiles.map(sourceFile => {
        ...
        const { propsSymbol, componentSymbol } = (0, extractor_1.extractExports)(name, exportSymbols, checker, (_a = options === null || options === void 0 ? void 0 : options.extraExports) !== null && _a !== void 0 ? _a : {});
        ...
        const componentDescription = (0, type_utils_1.getDescription)(componentSymbol.getDocumentationComment(checker), (0, type_utils_1.extractDeclaration)(componentSymbol));
        return (0, component_definition_1.buildComponentDefinition)(name, dashCaseName, props, functions, defaultValues, componentDescription, checker);
    });
}
